	...
	tests := []struct {
	...
	}{
		{
			...
			give: xhttp.DetailError{
				...
				RequestID:     "447bbf3a-6ad7-4c8a-8d51-62d28e00b0ca",
				Status:        http.StatusNotFound,
			},
			want: "404 (447bbf3a-6ad7-4c8a-8d51-62d28e00b0ca): Resource Not Found: The requested resource does not exist.",
		},
		{
...
func TestDetailError_MarshalJSON(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: `{"title":"Resource Not Found","detail":"The requested resource does not exist.","documentation":"https://example.com/docs/errors#not-found","requestID":"447bbf3a-6ad7-4c8a-8d51-62d28e00b0ca","status":404}`,
		},
		{
			name: "title empty, derived from status",
			give: xhttp.DetailError{
...
func TestDetailError_WriteJSON(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantBody:   `{"title":"Resource Not Found","detail":"The requested resource does not exist.","documentation":"https://example.com/docs/errors#not-found","requestID":"447bbf3a-6ad7-4c8a-8d51-62d28e00b0ca","status":404}` + "\n",
